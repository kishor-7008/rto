        ...
        <Box className="breakContainer">
            <Box className="headingflex ">
                <Box className="header3">
                    <h3 className="headingR">Side - Slip Test</h3>
                </Box >
            ...
            <Box className="content">
                ...
                <div className='box-container'>
                    <div style={{width:"50%",textAlign:"right",marginTop:"150px"}}>
                       ...
                       <img src="https://www.vhv.rs/dpng/d/409-4098491_car-of-hatchback-model-sedan-car-icon-png.png" style={{width:"100px",height:"100px",marginLeft:"30px"}}/>
                       <br/>
                       <br/>
                       <br/>
                       ...
                       <img src="https://simg.nicepng.com/png/small/97-975571_peersome-picture-stock-car-side-view-clipart.png" style={{width:"100px",height:"100px",marginLeft:"30px"}}/>
                       <br/>
                       <br/>
                       <br/>
                       ...
                       <input style={{padding:"30px",width:"200px",heigth:"200px"}} className="inputDetail"  value={"00.00 KG"}/>
                       <img src="https://thumbs.gfycat.com/AdoredGrippingAnemonecrab-size_restricted.gif" style={{width:"100px",height:"100px",marginLeft:"30px"}}/>
                   
                    </div>
                    <div style={{width:"50%",textAlign:"center"}}>
                       <div style={{fontSize:"30px",fontWeight:"bold",marginTop:"50px"}}>Weight : 00.00 KG</div>

                       <div style={{fontSize:"30px",fontWeight:"bold",borderRadius:"30px",marginBottom:"50px"}}>
                        <img src='https://hips.hearstapps.com/hmg-prod/images/img-5579-6411cfec8fcd4.gif' style={{borderRadius:"30px",width:"200px",marginTop:"50px"}}/></div>
                       
                        

                        <Link to="/speed/test"><Button style={{width:"200px",padding:"20px",background:"green",fontSize:"30px",color:"white",borderRadius:"30px", backgroundImage: "linear-gradient(#243d83, #7a99ef)"}} > Start</Button></Link>
                    </div>
