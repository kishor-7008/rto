...
const RTOLogin = () => {
  ...
  <div className="hero">
        ...
        <div className="city"></div>
          <div className="car2">
          <img className="carImage2" src="https://i.ibb.co/sK5GKp2/car.png" alt="car" border="0" />
        </div>
        <div className="wheel">
          <img
  ...
  <div className="boxces">
          ...
          <form className="form">
            ...
            <input
              ...
              required=""
            />
            <Link to='/dashboard'> <button className="button1">Log in</button></Link>
