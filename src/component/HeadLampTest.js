        ...
        <Box className="breakContainer">
            <Box className="headingflex ">
                <Box className="header3">
                    <h3 className="headingR">Head Lamp Test</h3>
                </Box >
            ...
            <Box className="content">
                ...
                <div className='box-container'>
                    <div style={{width:"50%",textAlign:"right",marginTop:"150px"}}>
                       ...
                       <input style={{padding:"30px",width:"200px",heigth:"200px"}} className="inputDetail"  value={"00.00 KG"}/>
                       <img src="https://thumbs.gfycat.com/CharmingMasculineBandicoot-max-1mb.gif" style={{width:"100px",height:"100px",marginLeft:"30px",borderRadius:"30px"}}/>
                   
                    </div>
                    <div style={{width:"50%",textAlign:"center"}}>
                       <div style={{fontSize:"30px",fontWeight:"bold",borderRadius:"30px",marginBottom:"50px"}}><img src={'/image/headline.gif'} style={{borderRadius:"30px",width:"300px"}}/></div>
                        
                        

                       <Link to="/suspention"><Button style={{width:"200px",padding:"20px",background:"green",fontSize:"30px",color:"white",borderRadius:"30px", backgroundImage: "linear-gradient(#243d83, #7a99ef)"}}> Start</Button></Link>
