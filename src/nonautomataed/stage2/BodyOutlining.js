...
export default function BodyOutlining() {
        ...
        <>
            <section>
                ...
                <div class="mask-image" style={{ background: "black", height: "100vh", width: "100%" }}>
                    <div style={{ width: "100%", height: "10vh", textAlign: "center", fontSize: "50px", fontWeight: "bold", color: "blue" }}>2.7 - Body Outlining Marking Lights</div>
